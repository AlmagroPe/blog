...
export function BaseFooter({ 
    ...
    const socialLinks = [
        { href: "mailto:pabloalmagrope@gmail.com", icon: <Mail className="w-3 h-3 sm:w-4 sm:h-4" /> },
        { href: "https://github.com/AlmagroPe", icon: <Github className="w-3 h-3 sm:w-4 sm:h-4" /> },
        { href: "https://x.com/PabloAlmagroPe", icon: <Twitter className="w-3 h-3 sm:w-4 sm:h-4" /> }
    ]
                ...
                {(showSocialLinks || showCopyright) && (
                    <div className="flex items-center justify-center gap-6 sm:gap-8">
                        ...
                        {showCopyright && (
                            ...
                            >
                                © {new Date().getFullYear()} Pablo Almagro
                            </motion.span>
                        )}
                    </div>
                )}
